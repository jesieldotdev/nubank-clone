...
export const Messages = () => {
    return (
        <div className='bg-primary px-12 py-6 flex gap-4 text-xs'>
            ...
            <div className="bg-customGray2 rounded-xl mr-4  items-center  px-6 py-4 max-w-72 transition-all animate-slide-in-right">
            ...
            <div className="bg-customGray2 rounded-xl mr-12 items-center flex px-6 py-4 max-w-72 transition-all  duration-75 animate-slide-in-top">
